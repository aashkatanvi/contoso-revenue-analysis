...
-- INSIGHT: Online is the most discount-dependent channel (~69% of transactions),
-- with the lowest post-discount margins, indicating that heavy discounting
-- is a key contributor to margin erosion compared to other channels.	
...
-- INSIGHT: Online is the only channel with revenue growth, but it is driven by
-- transaction volume (+38%) rather than value, as AOV declined ~27%,
-- making growth inefficient.	
...
-- INSIGHT: Online margins continue to decline despite stable discount rates,
-- suggesting that falling AOV is a key compounding factor impacting profitability,
-- indicating a structural inefficiency beyond discounting alone.	
